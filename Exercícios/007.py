"""1. Faça um programa que possua uma lista denominada A que armazene 6 números inteiros. O programa
...
vetorA: list[int] = [1, 0, 5, -2, -5, 7]

soma: int = vetorA[0] + vetorA[1] + vetorA[2]

vetorA[5] = 100

print(f'A soma dos valores da é {soma}')
